...
void lightSensorTask(void *pvParameter){
  ...
  while(1)
  {
    ...
    if(q == NULL){
        ...
        xQueueSend(q,(void *)&calibratedValues[AS726x_VIOLET],(TickType_t )0);
        xQueueSend(q,(void *)&calibratedValues[AS726x_BLUE],(TickType_t )0);
        xQueueSend(q,(void *)&calibratedValues[AS726x_GREEN],(TickType_t )0);
        xQueueSend(q,(void *)&calibratedValues[AS726x_YELLOW],(TickType_t )0);
        xQueueSend(q,(void *)&calibratedValues[AS726x_ORANGE],(TickType_t )0);
        xQueueSend(q,(void *)&calibratedValues[AS726x_RED],(TickType_t )0);
    }
