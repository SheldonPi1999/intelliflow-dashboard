...
#define I2C_MASTER_SCL_IO 22 // CONFIG_I2C_MASTER_SCL               /*!< gpio number for I2C master clock */
#define I2C_MASTER_SDA_IO 21 // CONFIG_I2C_MASTER_SDA               /*!< gpio number for I2C master data  */
