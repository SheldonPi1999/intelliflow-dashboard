...
void pressureSensorTask(void) {
    ...
    const byte MPS_OUT_pin2 = 22; // OUT data pin
    const byte MPS_SCK_pin2 = 21; // clock data pin
    ...
    while(1) {
        printf(Sensor_1.read()*1013.25/8800000*100);
        delay(1000);
        Serial.println(Sensor_2.read()*1013.25/8425000*100);
        delay(1000);
    }
}
