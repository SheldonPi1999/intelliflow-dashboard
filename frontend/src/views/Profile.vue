    ...
    methods: {
        async uploadImage() {
            try {
                ...
                await axios.post(('http://' + apiSettings.apiServerIP + ':' + apiSettings.apiServerPort + '/uploads'), formData, {
                    headers: {
        ...
        async updateUser() {
            this.editedUser.imageUrl = `http://${apiSettings.apiServerIP}:${apiSettings.apiServerPort}/images/${this.image.name}`;
            this.uploadImage();
            try {
